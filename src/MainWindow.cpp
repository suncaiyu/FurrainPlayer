...
//    ui->page_video->installEventFilter(this);
    ...
    resize(1024,768);
    setTitle(QStringLiteral("FurrainPlayer-V%1").arg(AppConfig::VERSION_NAME));
...
{
//    int controlHeight = ui->widget_controller->height();
//    QRect controlRect(0, height() - controlHeight, width(), controlHeight);
//    if (controlRect.contains(event->pos()) && isControlShow == false) {
//        qDebug() << "1111";
//        showOutControlWidget();
//    }
//    if (!controlRect.contains(event->pos()) && isControlShow == true) {
//        qDebug() << "2222";
//        hideControlWidget();
//    }
//    update();
    DragAbleWidget::mouseMoveEvent(event);
}
